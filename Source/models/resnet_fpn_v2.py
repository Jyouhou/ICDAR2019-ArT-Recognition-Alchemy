...
class BuildBlock(nn.Module):
    def __init__(self, planes=256):
        ...
        self.latlayer4 = nn.Conv2d(
            64, planes, kernel_size=1, stride=1, padding=0)
...
class ResNet_FPN_v2(nn.Module):
    def __init__(self, num_layers=50):
        super(ResNet_FPN_v2, self).__init__()
    ...
    def forward(self, x):
        ...
        c4 = self.head4(c3)
        c5 = self.head5(c4)
        p1, p2, p3, p4, p5 = self.fpn(c1, c2, c3, c4, c5)
        net_conv = [p1, p2, p3, p4, p5]
    ...
    def _init_head_tail(self):
        ...
        self.head3 = nn.Sequential(self.resnet.layer2)  # /8
        self.head4 = nn.Sequential(self.resnet.layer3)  # /16
        self.head5 = nn.Sequential(self.resnet.layer4)  # /32
