...
class ResNet_FPN(nn.Module):
    ...
    def _init_head_tail(self):
        ...
        self._layers['head'].append(nn.Sequential(self.resnet.layer2))  # /8
        self._layers['head'].append(nn.Sequential(self.resnet.layer3))  # /16
        self._layers['head'].append(nn.Sequential(self.resnet.layer4))  # /32
